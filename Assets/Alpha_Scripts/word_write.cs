...
public class word_write : MonoBehaviour
{
...
//          VARIABLES NEED TO BE CHANGED 
			...
			float x_of_e = script_e.x;
				...
				Debug.Log ("I GET " + x_of_w + ", " + x_of_r + ", " + x_of_i + ", " + x_of_t + ", " + x_of_e);
			...
			if (x_of_w == 0 && x_of_r == 0 && x_of_i == 0 && x_of_t == 0 && x_of_e == 0)
				return;
			...
			{
				if (flip_w || flip_r || flip_i || flip_t || flip_e)
				{
					if (flip_w == true) {
				...
				else if (x_of_e > x_of_t && x_of_t > x_of_i && x_of_i > x_of_r && x_of_r > x_of_w)
				{
